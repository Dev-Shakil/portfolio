...
const SingleSkills = ({skill}) => {
  return (
    <div className={`p-5 cursor-pointer flex justify-center items-center flex-col w-fit h-fit border-primary rounded-lg border-4  hover:duration-500 hover:scale-125 transition ease-in-out hover:bg-${skill?.bg}`}>
