...
const Hero = () => {
  return (
    <div className="bg-[#f9f9f9] w-full h-fit md:h-[80vh] md:py-2 py-10 flex justify-center flex-col">
      <div className="md:flex justify-around md:items-center md:h-[70vh] w-[90%] md:max-w-[900px] lg:max-w-[1100px] mx-auto items-end animate-hero-stagger">
        ...
        <div className="hero_text lg:w-[65%] md:w-[55%] w-full min-h-[30vh] md:h-fit flex md:block flex-col justify-center items-center px-8">
          <h2 className="text-3xl md:text-5xl lg:text-7xl font-semibold text-center md:text-start leading-normal text-[#2d2e32] animate-fade-in-up">
            Front-End React Developer
          </h2>
          <p className="md:w-[450px] w-full md:text-start text-center mt-4 text-lg text-[#555] font-medium animate-fade-in-up delay-200">
          ...
          <div className="flex mt-4 gap-4 text-[#555] items-center animate-fade-in-up delay-400">
            <Link
              href="/resume.pdf"
              target="_blank"
              className="py-3 px-6 font-semibold border-black border-2 hover:bg-black hover:text-white rounded-lg duration-500"
            >
              Resume
            </Link>
            <Link href="https://www.linkedin.com/in/mohammed-shakil1007" target="_blank">
              <FaLinkedin className="hover:text-blue-600 text-4xl transition-transform duration-500 hover:scale-110" />
            </Link>
            <Link href="https://github.com/Dev-Shakil" target="_blank">
              <BsGithub className="text-4xl hover:text-black transition-transform duration-500 hover:scale-110" />
            </Link>
          </div>
        </div>
