...
const Footer = () => {
  return (
    <div className="md:w-[80%] mx-auto flex justify-center items-center w-[95%] flex-wrap py-2 bg-gray-700">
        <h2 className=" text-center text-lg md:text-xl text-white">Copyright © 2025. All rights are reserved</h2>
